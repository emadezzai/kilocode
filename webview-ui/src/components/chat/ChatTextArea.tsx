...
import { VolumeX, Pin, Check, WandSparkles, SendHorizontal, Paperclip, MessageSquareX, Globe } from "lucide-react"
		...
		const renderTextAreaSection = () => (
			<div
				...
				<div className="absolute bottom-2 end-2 z-30 flex items-center gap-1">
					...
					<StandardTooltip content="Pick Browser Element">
						<button
							aria-label="Pick Browser Element"
							onClick={() => {
